class PointAxisLineVisualPromptsController < ApplicationController
  ...
  polymorphic_auto_actions_for :give_up_multiple_choice_sequence, [ :index, :new, :create ]
  polymorphic_auto_actions_for :confirm_correct_multiple_choice_sequence, [ :index, :new, :create ]
