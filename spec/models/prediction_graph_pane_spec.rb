...
describe PredictionGraphPane do
  ...
  describe "zero argument constructor defaults" do
    describe "#to_hash" do
      let(:expected_hash) { 
        {"type"=>"PredictionGraphPane", "title"=>nil, "yLabel"=>nil, "yUnits"=>nil, "yMin"=>nil, "yMax"=>nil, "xLabel"=>nil, "xUnits"=>nil, "xMin"=>nil, "xMax"=>nil, "yTicks"=>nil, "yPrecision"=>0.1, "xTicks"=>nil, "xPrecision"=>0.1, "predictionType"=>nil} 
      }
 ...
 describe "with some interesting attributes" do
    ...
    describe "#to_hash" do
      let(:expected_hash) { 
       {"type"=>"PredictionGraphPane", "title"=>"x in terms of y", "yLabel"=>"y", "yUnits"=>nil, "yMin"=>0.0, "yMax"=>1.0, "xLabel"=>"x", "xUnits"=>nil, "xMin"=>0.0, "xMax"=>10.0, "yTicks"=>0.1, "yPrecision"=>0.1, "xTicks"=>1.0, "xPrecision"=>0.1, "predictionType"=>"connecting_points"}
      }  
      it "should match our expected hash" do
        subject.to_hash.should == expected_hash
      end
