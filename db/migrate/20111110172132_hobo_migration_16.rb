class HoboMigration16 < ActiveRecord::Migration
  def self.up
    ...
    add_index :confirm_correct_prompts, [:pick_a_point_sequence_id]
    ...
    add_index :give_up_prompts, [:pick_a_point_sequence_id]
    ...
    add_index :initial_prompt_prompts, [:pick_a_point_sequence_id]
